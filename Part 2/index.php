...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="Part 1/styles/index.css">
...
<body>
    ...
    <main>
        ...
        <h2> Our Purpose </h2>
            ...
            <img src="Part 1/images/revenue_index.png" alt="Client's company growth before and after using solvex" title="Graph display a clear increase in revenue after implementing Solvex's solutions, reflecting the positive impact on business performance." loading="lazy">
        ...
        <h2>Why choose Solvex </h2>    
            ...
            <img src="Part 1/images/employee_index.png" alt="Employees' satisfaction" title="Employees' satisfaction image" loading="lazy"> <!-- Image: Chategpt command prompt: Can you create an image based on For employees-->
        </section>
